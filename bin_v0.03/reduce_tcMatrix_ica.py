...
the_icaModel = ica.icaModel()
the_icaModel.initializeModel(matrixDirectory, outputDirectory, the_tcMatrix.coocMatrix, the_tcMatrix.subTargetIndexDict, the_tcMatrix.columnIndexDict)
the_icaModel.computeICA()
the_icaModel.outputModelInfo()